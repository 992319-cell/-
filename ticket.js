...
const LOCATION_DATA = {
  ...
  taichung: {
    ...
    districts: {
      ...
      north:  { name: "北區", shops: [
        { id: "s303", name: "順發機車　一中店",   rating: 4.5 },
      ]},
      beitun: { name: "北屯區", shops: [
  ...
  tainan: {
    ...
    districts: {
      ...
      north:    { name: "北區", shops: [
        { id: "s403", name: "順發機車　公園店",   rating: 4.6 },
      ]},
      yongkang: { name: "永康區", shops: [
  ...
  kaohsiung: {
    name: "高雄市",
    districts: {
      sanmin:  { name: "三民區", shops: [
        { id: "s501", name: "光陽機車行　三民店", rating: 4.6 },
        { id: "s502", name: "順發機車　建工店",   rating: 4.5 },
      ]},
      lingya:  { name: "苓雅區", shops: [
        { id: "s503", name: "三陽車業　苓雅店",   rating: 4.7 },
      ]},
      zuoying: { name: "左營區", shops: [
...
const fp = flatpickr(dateInput, {
  locale: (typeof flatpickr !== "undefined" && flatpickr.l10ns && flatpickr.l10ns.zh_tw) ? flatpickr.l10ns.zh_tw : "default",
  minDate: tomorrow,
  maxDate: maxDate,
  dateFormat: "Y / m / d",
  disableMobile: true,
...
function renderShops(shops) {
  ...
  shopListEl.querySelectorAll(".tk-shop-card").forEach(card => {
    card.addEventListener("click", () => {
      shopListEl.querySelectorAll(".tk-shop-card").forEach(c => c.classList.remove("is-selected"));
...
function renderAside() {
  ...
  if (state.shop) {
    ...
    const distName = state.district && state.city
