(function (window) {
  ...
  function computeStats(data) {
    ...
    var prices = sorted.map(function (d) {
      return d.price;
    });
    return {
      min: prices[0],
  ...
  function buildDots(stats, opts) {
    ...
    return stats.data
      .map(function (d, i) {
        ...
        return (
          '<span class="spec-dot" style="left:' +
          x.toFixed(2) +
          "%;top:" +
          y +
          "%;--i:" +
  ...
  function buildHTML(stats, opts) {
    ...
    if (opts.yourPrice !== null && opts.yourPrice !== undefined) {
      ...
      youHTML =
        '<div class="spec-you" style="left:' +
        youPos.toFixed(2) +
        '%">' +
        '<span class="spec-you-flag">' +
        '<span class="spec-you-num" data-anim-to="' +
        opts.yourPrice +
        '" data-anim-prefix="$">$' +
        opts.yourPrice +
        "</span>" +
        '<span class="spec-you-tag">' +
        youTag +
        " · 你</span>" +
        "</span>" +
        "</div>";
    ...
    return (
      '<div class="spec spec--' +
      opts.variant +
      (opts.yourPrice == null ? " spec--no-you" : "") +
      '">' +
      '<div class="spec-scroll-host">' +
      '<div class="spec-scroll">' +
      '<div class="spec-scroll-inner">' +
      '<div class="spec-wrap">' +
      '<div class="spec-swarm">' +
      buildDots(stats, opts) +
      "</div>" +
      '<div class="spec-track">' +
      '<div class="spec-iqr" style="left:' +
      iqrLeft.toFixed(2) +
      "%;right:" +
      iqrRight.toFixed(2) +
      '%"></div>' +
      '<div class="spec-median" style="left:' +
      medPos.toFixed(2) +
      '%"></div>' +
      youHTML +
      "</div>" +
      ...
      stats.min +
      "</span>" +
      '<span class="spec-shop">' +
      buildShopLabel(stats.minRec) +
      "</span>" +
      "</div>" +
      ...
      '<span class="spec-sum-val" data-anim-to="' +
      ...
      '<span class="spec-sum-val spec-sum-val--green">$' +
      ...
      "</div>" +
      '<div class="spec-foot">' +
      '<span class="spec-foot-l">樣本　<strong>' +
